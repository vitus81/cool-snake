...
cool-snake: raylib
ifneq (,$(cool_snake_config))
	@echo "==== Building cool-snake ($(cool_snake_config)) ===="
	@${MAKE} --no-print-directory -C build/build_files -f cool-snake.make config=$(cool_snake_config)
endif
...
clean:
	@${MAKE} --no-print-directory -C build/build_files -f cool-snake.make clean
